    ...
    <PublicLayout>
      <section className="bg-gradient-to-b from-accent/5 to-primary-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-text-muted max-w-2xl mx-auto">
            Immersive video content from our community of creators. Click to watch.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {videos.map((v: any) => (
            <VideoLightbox key={v.id} src={v.src} title={v.title}>
              <div className="card overflow-hidden group hover:shadow-md transition-shadow cursor-pointer">
                <div className="aspect-[9/16] relative bg-gradient-to-br from-accent/20 to-gold-bg/30 overflow-hidden">
                  <Image src={v.thumbnail} alt={v.title || ""} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width:768px) 100vw, 33vw" />
